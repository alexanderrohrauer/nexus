...
from app.services import openalex_dataprocess_service, works_service, researchers_service
...
async def openalex_import_job(n_batches: int, keywords: list[str], cursor: Cursor, cron_expr: str):
    ...
    for i in range(n_batches):
        ...
        researchers = openalex_dataprocess_service.restructure_authors(authors)
        async with lock:
