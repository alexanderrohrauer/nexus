...
# TODO Check why we need to exectute deduplication multiple times
        ...
        for current_institution in reversed(institutions):
            for prev_institution in institutions:
                if prev_institution.uuid != current_institution.uuid:
                    ...
                    elif prev_institution.name == current_institution.name and prev_institution.city == current_institution.city and prev_institution.country == current_institution.country:
                        duplication_key = uuid4()
                        print(
